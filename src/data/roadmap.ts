...
export const phases: Phase[] = [
  ...
  },
  {
    ...
    modules: [
      mod("crewai", "What is CrewAI"),
      mod("crewai-architecture", "CrewAI Architecture"),
      mod("crewai-agents-roles", "Agents: Role, Goal, Backstory"),
      mod("crewai-tasks-process", "Tasks"),
      mod("crewai-tools", "Tools"),
      mod("crewai-processes", "Processes"),
      mod("crewai-delegation", "Agent Delegation"),
      mod("crewai-memory", "Memory"),
      mod("crewai-knowledge", "Knowledge and RAG"),
      mod("crewai-flows", "Flows"),
      mod("crewai-hybrid", "Crew + Flow Hybrid"),
      mod("crewai-production", "Production Patterns"),
      mod("crewai-deployment", "Deployment"),
      mod("build-crewai-crew", "Build a Research Crew"),
    ],
    projects: ["AI Research Crew"],
  },
  {
    id: 14,
    slug: "pydantic-ai",
